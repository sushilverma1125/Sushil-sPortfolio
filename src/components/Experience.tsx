  ...
  const experiences = [
    {
      ...
      description:
        "Working as a Product Design Intern, contributing to product, dashboard, and website redesign initiatives while improving internal design workflows.",
      achievements: [
        {
          icon: Zap,
          title: "Custom Figma Plugin – TaskLogger",
          description:
            "Built a custom Figma plugin to track designers’ daily tasks and design file changes, improving workflow visibility"
        },
        {
          icon: TrendingUp,
          title: "Dashboard UI Revamp",
          description:
            "Redesigned outdated dashboards to improve usability, accessibility, and design consistency across modules"
        },
        {
          icon: Users,
          title: "Product & Website Redesign",
          description:
            "Designed intuitive app feature screens and contributed to the redesign of Omniful’s official website"
        }
      ],
      skills: [
        "Product Design",
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Gaining hands-on experience in UI/UX and product design while
            continuously learning and improving real-world digital products.
          </p>
        </div>
        ...
        {experiences.map((experience, expIndex) => (
          <div
            key={expIndex}
            className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden mb-16 transition-colors duration-300"
          >
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-8">
                {experience.achievements.map((achievement, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className="text-center p-6 bg-gray-50 dark:bg-gray-700 rounded-xl transition-colors duration-300"
                    >
        ...
        <div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {certificates.map((cert, index) => (
              ...
              >
                <div
                  className={`w-full h-32 bg-gradient-to-r ${cert.color} rounded-xl mb-6 flex items-center justify-center`}
                >
